...
\hypersetup
{
    ...
    pdftitle={Webacula v.7.x. Installation Manual},
...
\htmladdnormallink{send a bug report}{http://webacula.tim4dev.com/}.

Thanks.

Webacula has a number of email lists.
For general information subscribing to or unsubscribing from these lists, please see 
\htmladdnormallink{Webacula Mailing Lists}{http://webacula.tim4dev.com/}.
...
\htmladdnormallink{Download minimal Zend Framework package}{http://framework.zend.com/downloads/archives/} and extract.
...
\section{Upgrade from prior version}
\label{Upgrade}
...
\subsection{Upgrade from 5.5.1 to 5.5.2}
\label{Upgrade: from 5.5.1 to 5.5.2}

Upgrade the code as usual.
...
\subsection{Upgradee from 5.x to 7.x}
\label{Upgrade: from 5.x to 7.x}

Now the Webacula Users password hasher implements the 
\htmladdnormallink{Portable PHP password hashing framework}{http://www.openwall.com/phpass/},
