...
\htmladdnormallink{send a bug report}{http://sourceforge.net/projects/webacula/}.

Thanks.

Webacula has a number of email lists.
For general information subscribing to or unsubscribing from these lists, please see 
\htmladdnormallink{Webacula Mailing Lists at SourceForge}{http://sourceforge.net/p/webacula/mailman/}.
